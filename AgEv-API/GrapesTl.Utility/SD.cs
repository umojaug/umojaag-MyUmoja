...
{
    public const string BaseUrl = "https://umug.umoja-international.com";
    ...
    public const string Message_InvalidLedger = "Select Correct Accounts Code";
    ...
    public const string EmptyReportMessage = "<div style='text-align: center;'>Not Found</div>";
