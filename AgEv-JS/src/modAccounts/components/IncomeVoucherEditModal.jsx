...
const IncomeVoucherEditModal = ({
  ...
  const addItem = async () => {
    ...
    try {
      ...
      if (expenseExists) {
        toast.error(`Income "${expenseName}" is already added to the list!`);
        return;
      }
...
export default IncomeVoucherEditModal;
