    ...
    <>
      <div className="flex justify-end">
        ...
        <PdfButton
          ...
          filename="DayBookReport.pdf"
        />
        <ExcelButton
          path={`/acDayBook/ExportToExcel/${dataForm.fromDate}/${dataForm.tillDate}`}
          filename={`DaybookReport_${format(
            new Date(dataForm.fromDate),
            "dd-MM-yyyy"
          )}_${format(new Date(dataForm.tillDate), "dd-MM-yyyy")}.xlsx`}
        />
      </div>
