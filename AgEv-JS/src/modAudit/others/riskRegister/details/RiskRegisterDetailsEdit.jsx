...
import RiskRegisterDetailsFrom from "./RiskRegisterDetailsFrom";
import { AiOutlineForm } from "react-icons/ai";
import { useGetData } from "../../../../hooks/dataApi";
import { HashLoading } from "../../../../components/Loading";
import Error from "../../../../components/Error";

const RiskRegisterDetailsEdit = ({ riskRegisterDetailsId }) => {
  let [isOpen, setIsOpen] = useState(false);

  // const { id } = riskRegisterDetailsId;
  ...
  const {
    ...
    "areaOfReview",
    `/riskRegisterDetails/details/${riskRegisterDetailsId}`
  );
        ...
        >
          ...
          <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4">
              ...
              >
                <RiskRegisterDetailsFrom
                  closeModal={closeModal}
                  riskRegisterDetailsId={riskRegisterDetailsId}
                  path="/RiskRegisterDetails/updateRiskParameter"
                  defaultValues={{
                    likelihoodRating: list.data.likelihoodRating,
...
export default RiskRegisterDetailsEdit;
