...
export const Select2FromDb = ({
  ...
  const getSelectedOptionLabel = (value) => {
    ...
    const selected = lists.data.find((item) => item.listId === value);
    return selected ? selected.listName : "";
  };
